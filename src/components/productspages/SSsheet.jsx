  ...
  return (
    ...
    <div>
      <section className="hero-about">
        <h1 style={{ color: 'white' }}>SS Sheet Metal Parts</h1>
      </section>
            ...
            <div className="col-lg-12">
              <div className="row">
                ...
                >
                  ...
                  <h3 className='py-3'>Superior Strength and Durability</h3>
                  <p className='py-3 lh-lg'>
                  ...
                  <h3 className='py-3'>Corrosion and Rust Resistance</h3>
                  <p className='py-3 lh-lg'>
                  ...
                  <h3 className='py-3'>Hygienic and Easy to Clean</h3>
                  <p className='py-3 lh-lg'>
                  ...
                  <h3 className='py-3'>Expertise in Stainless Steel Fabrication</h3>
                  <p className='py-3 lh-lg'>
                  ...
                  <h3 className='py-3'>Applications of Stainless Steel Sheet Metal Parts</h3>
                  <ul>
                    <li className='py-2'>Healthcare Industry: Medical equipment, surgical instruments, and hospital fixtures</li>
                    <li className='py-2'>Food Processing: Machinery parts, food handling equipment, and storage containers</li>
                    <li className='py-2'>Automotive Industry: Exhaust systems, automotive trim, and engine components</li>
                    <li className='py-2'>Construction Sector: Architectural features, structural components, and building facades</li>
                    <li className='py-2'>Marine Industry: Boat fittings, marine hardware, and nautical equipment</li>
                    <li className='py-2'>Industrial Applications: Machinery parts, equipment enclosures, and manufacturing tools</li>
                  </ul>
